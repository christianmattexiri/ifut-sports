...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "iFut Auth Hub provides secure user authentication for the iFut App SaaS." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "iFut Auth Hub provides secure user authentication for the iFut App SaaS." },
