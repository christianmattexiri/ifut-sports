...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "iFut Sports" },
      { name: "description", content: "Venha organizar sua pelada do jeito certo!" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "iFut Sports" },
      { property: "og:description", content: "Venha organizar sua pelada do jeito certo!" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "iFut Sports" },
      { name: "twitter:description", content: "Venha organizar sua pelada do jeito certo!" },
